...
public class Copa {
	public static void main (String[] args) {
		...
		Arq.openWrite("matrı́cula sequencial.txt");
...
class Ranking extends Time {
	...
	public static int procurar(String s) {
		...
		int comparacoes = 0;
		//for(int i = 0;i < c;i++) {
		while(!leituraValida && i < c) {
			if(s.equals(team[i].getPais())) {
				leituraValida = true;//caso ache o mesmo pais o boolean ficara verdadeiro
				comparacoes++;			
			}			
			i++;
		}//fim while
